...
public class PanelConvert extends javax.swing.JPanel {
    ...
    public PanelConvert() {
        initComponents();
        setOpaque(false);
        layout = new MigLayout("wrap, fill", "[center]", "push[]25[]10[]25push" );
        setLayout(layout);
        init();
    }
    ...
    protected void paintComponent(Graphics grphcs) {
        ...
        GradientPaint gra = new GradientPaint(0, 0, new Color(17,199,161), 0, getHeight(), new Color(19,175,187  ));
        g2.setPaint(gra);
    ...
    public void loginLeft (double v){
     v = Double.valueOf(df.format(v));
         login(true);
         layout.setComponentConstraints(title, "pad 0 " + v + "% 0 " + "%");
         layout.setComponentConstraints(description, "pad 0 " + v + "% 0 " + "%");
         layout.setComponentConstraints(description1, "pad 0 " + v + "% 0 " + "%");
    ...
    public void login(boolean login) {
        if (this.isLogin != login) {
            if (login) {
                ...
                description.setFont(new Font ("sansserif" , 1 , 15));
                description1.setText("and start journey with us");
                description1.setFont(new Font ("sansserif" , 1 , 15));
